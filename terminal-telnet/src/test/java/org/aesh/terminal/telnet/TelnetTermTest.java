...
public abstract class TelnetTermTest extends TelnetTestBase {
    ...
    public void testSizeHandler() throws Exception {
        ...
        client.writeDirectAndFlush(new byte[] { TelnetConnection.BYTE_IAC, TelnetConnection.BYTE_SB, 31, 0, (byte) 180, 0,
                (byte) 160, TelnetConnection.BYTE_IAC, TelnetConnection.BYTE_SE });
        await();
    }
}
