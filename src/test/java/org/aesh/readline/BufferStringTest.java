...
public class BufferStringTest {
    ...
    public void testPrintAnsi() {
        ...
        assertEquals(new String(expected), new String(BufferString.printAnsi("J")));

        expected = new char[] {(char) 27, '[', 'J','p'};
        assertEquals(new String(expected), new String(BufferString.printAnsi("Jp")));

        expected = new char[] {(char) 27, '[', ' ',' ',' ',' '};
        assertEquals(new String(expected), new String(BufferString.printAnsi("\t")));

        expected = new char[] {(char) 27, '[', ' ',' ',' ',' ','B'};
        assertEquals(new String(expected), new String(BufferString.printAnsi("\tB")));
