 ...
 * Based on the wcwidth implementation by Markus Kuhn.
 */
public final class WcWidth {
    ...
    private static boolean bisearch(int ucs, int max) {
        int min = 0;
        int mid;
     ...
     * <li>Non-spacing and enclosing combining characters have a column width of 0.</li>
     * <li>SOFT HYPHEN (U+00AD) has a column width of 1.</li>
     * <li>Other format characters and ZERO WIDTH SPACE (U+200B) have a column width of 0.</li>
     * <li>Hangul Jamo medial vowels and final consonants (U+1160-U+11FF) have a column width of 0.</li>
     * <li>East Asian Wide (W) or Full-width (F) characters have a column width of 2.</li>
     * <li>All remaining characters have a column width of 1.</li>
     * </ul>
     * <p>
     * This implementation assumes that wchar_t characters are encoded in ISO 10646.
     *
     * @param ucs the Unicode code point
     * @return the column width (0, 1, or 2), or -1 for control characters
     */
    public static int width(int ucs) {
        ...
        if (bisearch(ucs, COMBINING.length - 1))
            return 0;
