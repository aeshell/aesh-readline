...
public class IntArrayBuilderTest {
    ...
    public void appendInts() {
        org.aesh.terminal.utils.IntArrayBuilder builder = new org.aesh.terminal.utils.IntArrayBuilder();
        builder.append(1);
        ...
        builder = new org.aesh.terminal.utils.IntArrayBuilder(3);
        builder.append(3);
    ...
    public void appentIntArray() {
        ...
        builder = new org.aesh.terminal.utils.IntArrayBuilder(new int[] { 1, 2, 3 });
        assertArrayEquals(new int[] { 1, 2, 3 }, builder.toArray());
